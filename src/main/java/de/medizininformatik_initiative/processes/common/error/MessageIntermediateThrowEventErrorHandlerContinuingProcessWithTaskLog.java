...
public class MessageIntermediateThrowEventErrorHandlerContinuingProcessWithTaskLog
		extends MessageIntermediateThrowEventErrorHandlerContinuingProcess
{
	private static final Logger logger = LoggerFactory
			.getLogger(MessageIntermediateThrowEventErrorHandlerContinuingProcessWithTaskLog.class);

	/**
	 * Requires {@link RetryTaskSenderWithTaskStorage}
	 */
	public MessageIntermediateThrowEventErrorHandlerContinuingProcessWithTaskLog()
	{
		super();
	}

	/**
	 * Logs the given {@link Exception}.and the sent FHIR Task ressource, requires
	 * {@link RetryTaskSenderWithTaskStorage}
	 * <p>
