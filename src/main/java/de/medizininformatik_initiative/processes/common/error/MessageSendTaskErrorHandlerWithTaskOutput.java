...
public class MessageSendTaskErrorHandlerWithTaskOutput extends DefaultMessageSendTaskErrorHandler
{
	private final Function<Exception, Task.TaskOutputComponent> taskOutputGenerator;

	public MessageSendTaskErrorHandlerWithTaskOutput(Function<Exception, Task.TaskOutputComponent> taskOutputGenerator)
	{
